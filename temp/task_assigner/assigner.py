...
@dataclass
class AssignResult:
    assignment: Assignment        # {"tasks": [...], "people": [...], "notes": [...]} as returned
...
class TaskAssigner:
    ...
    def assign(
        ...
        contents: list[types.Content] = [_user(build_user_prompt(team_md, task_list))]
    ...
    def _generate(self, contents: list[types.Content]) -> tuple[Any, types.Content]:
        ...
        cfg = types.GenerateContentConfig(
            ...
            response_json_schema=ASSIGNMENT_SCHEMA,
