...
export function SetupScreen({ session }: { session: BriefSession }) {
  ...
  return <main id="main-content" className="screen screen-setup">
    ...
    <Card title="A shared starting point"><ol className="section-list"><li><strong>01 · Understand the project</strong><p className="subtle">Vision, deliverables, success criteria, and questions to resolve.</p></li><li><strong>02 · Understand the team</strong><p className="subtle">CV-backed strengths and coverage for 2–8 people.</p></li><li><strong>03 · Review and download</strong><p className="subtle">Two Markdown documents to share with your team.</p></li><li><strong>04 · Build the task flow</strong><p className="subtle">Explore tasks, prerequisites, and effort from the two briefs.</p></li></ol></Card>
